...
> *"I didn't just build it — I containerized it and shipped it to production."*

A fully-featured blogging platform **BloggerNepal**. This is my most complete project: a real content platform with recommendation, analytics, Cloudinary media, and a live deployment powered by Docker.

| | |
|---|---|
| 🐳 **Dockerized** | Containerized with Docker for consistent dev & production environments |
| ☁️ **Live on Render** | Deployed and running in production — visit it now! |
| 📊 **Analytics** | Post views, likes, and content recommendation built in |

**Key Features:**
- User registration, login, and profile management
- Blog creation with rich content, categories & slug-based URLs
- Content recommendation system
- Post analytics — views and likes tracking
- Featured, Latest, and Popular posts sections
- Categories: Education, Politics, Sports, Psychology & more
...
### 🎓 Student Study Portal — Learning Made Simple

> *"Built for students, by a student."*

A dedicated study portal giving students one central place to access notes, resources, and learning content. Clean, focused, and practical.

**Key Features:**
- Student registration and secure authentication
- Upload and manage study resources and notes
- Role-based access — student and admin views
- Clean, distraction-free UI designed for studying
...
<img src="https://cdn-icons-png.flaticon.com/512/1006/1006363.png" width="100"/><br><br>
<strong>🌐 Personal Portfolio</strong><br><br>
Responsive portfolio website showcasing my projects, skills, and experience. Built with pure HTML, CSS & JS.<br><br>
...
<td align="center" width="260px">
<img src="https://cdn-icons-png.flaticon.com/512/906/906334.png" width="100"/><br><br>
<strong>📝 Blog Post Web App</strong><br><br>
Django blog with user auth, CRUD operations, role-based permissions (Default/Premium), and staff user management.<br><br>
...
<td align="center" width="260px">
<img src="https://cdn-icons-png.flaticon.com/512/2621/2621303.png" width="100"/><br><br>
<strong>🏫 WsCubeTech Web App</strong><br><br>
Multi-feature Django app — services, news, contact forms, email notifications, pagination, calculator & marksheet tools.<br><br>
...
<td align="center" width="260px">
<img src="https://cdn-icons-png.flaticon.com/512/919/919853.png" width="100"/><br><br>
<strong>🐳 DevOps Journey</strong><br><br>
Currently taking a DevOps course — Docker, Nginx, CI/CD pipelines, containerization & production deployment.<br><br>

![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat&logo=docker&logoColor=white)
![Nginx](https://img.shields.io/badge/Nginx-009639?style=flat&logo=nginx&logoColor=white)
![GitHub Actions](https://img.shields.io/badge/GitHub_Actions-2088FF?style=flat&logo=githubactions&logoColor=white)<br><br>

*🚧 In Progress*
</td>

<td align="center" width="260px">
<img src="https://cdn-icons-png.flaticon.com/512/2103/2103533.png" width="100"/><br><br>
<strong>🧪 Practice & Demo Projects</strong><br><br>
A growing collection of Django & Python experiments — forms, ORM, email, pagination, and more learning projects.<br><br>
...
```
🐳 DevOps         →  Docker, Nginx, CI/CD pipelines, container orchestration
☁️ Cloud Deploy   →  Render, Cloudinary, production environment management
⚙️ Django Adv.    →  REST APIs, signals, middleware, advanced permissions
```
...
![Bikash's GitHub stats](https://github-readme-stats.vercel.app/api?username=BikashGosain&theme=tokyonight&show_icons=true&include_all_commits=true&count_private=true)
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=BikashGosain&theme=tokyonight&layout=compact)
...
<div align="center">
<img src="https://github-profile-trophy.vercel.app/?username=BikashGosain&theme=radical&no-frame=false&no-bg=false&margin-w=4"/>
</div>
...
- 🐳 I **Dockerized BloggerNepal** — I didn't just build it, I containerized and deployed it to production
- 📖 Currently enrolled in a **DevOps course** — mastering deployment and infrastructure alongside dev skills
- 🤝 I love collaboration
- 🌍 I learn by studying and cloning real-world projects to understand how professionals write code
- 🧪 I constantly experiment with new technologies and frameworks to stay sharp and updated
- 🇳🇵 Proudly building from **Bhaktapur, Nepal**
